...
export const FinalBill = pgTable(
  "final_bills",
  {
    ...
    serviceSubtotal: decimal("service_subtotal", { precision: 10, scale: 2 })
      .default("0")
      .notNull(),
    findingsSubtotal: decimal("findings_subtotal", { precision: 10, scale: 2 })
      .default("0")
      .notNull(),
    workTasksSubtotal: decimal("work_tasks_subtotal", {
      precision: 10,
      scale: 2,
    })
      .default("0")
      .notNull(),
    feesTotal: decimal("fees_total", { precision: 10, scale: 2 })
      .default("0")
      .notNull(),
  ...
  (table) => ({
    appointmentIdx: index("final_bills_appointment_idx").on(
      table.appointmentId,
    ),
  }),
);
